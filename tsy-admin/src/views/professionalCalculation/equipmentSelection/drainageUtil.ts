...
export const chonseTypeEquip = (e, updateSchema) => {
  ...
  updateSchema([
    ...
    },
    {
      ...
      show: ifShowObj.poolTopCoveringSoil,
      required: ifShowObj.poolTopCoveringSoil,
    },
    {
      field: 'pollShape',
      show: ifShowObj.pollShape,
      required: ifShowObj.pollShape,
    },
    {
      field: 'reusePumpFlow',
